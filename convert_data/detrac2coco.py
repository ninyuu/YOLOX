...
def main():
    ...
    image_base_dir = "/root/nyu/project/YOLOX/datasets/dataset/DETRAC/images/Insight-MVT_Annotation_Test"
    annotation_base_dir = "/root/nyu/project/YOLOX/datasets/dataset/DETRAC/Annotations/DETRAC-Test-Annotations-XML"
    new_image_dir = '/root/nyu/project/YOLOX/datasets/dataset/DETRAC/val2017_test'
    new_annotation_dir = '/root/nyu/project/YOLOX/datasets/dataset/DETRAC/annotations_test'
    new_json_name = 'instances_val2017_test.json'
