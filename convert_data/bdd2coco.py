...
def parse_arguments():
    ...
    parser.add_argument(
          "-l", "--label_dir",
        default="/root/nyu/project/YOLOX/datasets/dataset/bdd100k/bdd100k/labels/100k/",
          help="root directory of BDD label Json files",
    )
    parser.add_argument(
          "-s", "--save_path",
          default="/root/nyu/project/YOLOX/datasets/dataset/bdd100k/bdd100k/labels/100k/labels_coco",
